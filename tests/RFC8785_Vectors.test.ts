...
// استيراد المراجع الرسمية لضمان المطابقة
...
describe('PiRC-100: RFC 8785 Deterministic Vectors & Integrity Compliance', () => {
  ...
  /**
   * @test Official Protocol Reference Vectors
   * @description Direct validation against established JCS benchmarks.
   */
  describe('Official Reference Vector Validation', () => {
    referenceVectors.test_cases.forEach((vector) => {
      test(`Reference Case ${vector.id}: Should match expected JCS output`, () => {
